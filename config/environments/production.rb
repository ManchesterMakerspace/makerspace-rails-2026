Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {
    host: "https://#{::Util.is_prod? ? 'members.manchestermakerspace.org' : 'members.manchestermakerspace.com'}",
    protocol: "https"
  }
  ...
  warn "Warning: REDIS_DB is undefined!" unless ENV['REDIS_DB']
  ...
  if ENV['GMAIL_USERNAME'].present?
    ...
    warn '[Mailer] WARNING: No mail provider configured — email delivery disabled'
  end
