...
task :integration do
  ...
  builds_dir = File.join(rails_repo_dir, "app/assets/builds")
  FileUtils.mkdir_p(builds_dir)
  FileUtils.rm_rf(Dir.glob(File.join(builds_dir, "*")))
  FileUtils.cp_r(Dir.glob(File.join(react_repo_dir, "dist", "*")), builds_dir)
